describe('Sound descriptions', () => {
  ...
  it('Play a sound', () => {
    ...
    cy.get('description-display').find('.default-icon').should('be.visible')

    cy.get('description-display').find('button').click()
    cy.get('description-display').find('.active-icon').should('be.visible')
    cy.get('description-display').find('.default-icon').should('not.be.visible')

    cy.get('sound-element.with-audio').last().click()
    cy.get('description-display').find('.default-icon').should('be.visible')
    cy.get('description-display').find('.active-icon').should('not.be.visible')
  })
})
